...
比は同じラウンドどうしの比の中央値で、分母はすべて Cumo。1 未満なら Cumo が速い。後ろの n/10 は、10 ラウンドのうち比が 1 を超えた (相手が速かった) 回数。

### GPT-2 124M

tokens/sec (1 秒あたりに生成したトークン数)。大きいほど速い。

| KV キャッシュ | 生成長 | Cumo | CuPy | PyTorch | CuPy / Cumo | PyTorch / Cumo |
|---|---|---|---|---|---|---|
| 有り | 64 | 812.4 | 230.5 | 795.2 | 0.283 0/10 | 0.977 0/10 |
| 有り | 256 | 777.0 | 228.2 | 709.0 | 0.294 0/10 | 0.913 0/10 |
| 無し | 64 | 472.6 | 208.8 | 494.3 | 0.441 0/10 | 1.049 10/10 |
| 無し | 256 | 216.2 | 142.3 | 241.4 | 0.658 0/10 | 1.117 10/10 |

バッチ生成 (KV キャッシュ有り、長さ 256)。tokens/sec は全系列の合計で、大きいほど速い。

| batch | Cumo | CuPy | PyTorch | CuPy / Cumo | PyTorch / Cumo |
|---|---|---|---|---|---|
| 1 | 785.9 | 225.2 | 708.0 | 0.286 0/10 | 0.900 0/10 |
| 8 | 3824.4 | 1712.2 | 3613.3 | 0.449 0/10 | 0.942 0/10 |
...
| KV キャッシュ | 生成長 | Cumo | CuPy | PyTorch | CuPy / Cumo | PyTorch / Cumo |
|---|---|---|---|---|---|---|
| 有り | 64 | 723.7 | 217.5 | 535.2 | 0.300 0/10 | 0.773 0/10 |
| 有り | 200 | 722.3 | 218.4 | 553.7 | 0.306 0/10 | 0.775 0/10 |
| 無し | 64 | 465.7 | 203.0 | 456.0 | 0.436 0/10 | 0.976 0/10 |
| 無し | 200 | 253.4 | 172.9 | 263.9 | 0.683 0/10 | 1.045 10/10 |
...
| 生成長 | Cumo | CuPy | PyTorch | CuPy / Cumo | PyTorch / Cumo |
|---|---|---|---|---|---|
| 64 | 410.71 | 62.17 | 152.57 | 0.152 0/10 | 0.372 0/10 |
| 128 | 411.98 | 62.37 | 152.75 | 0.151 0/10 | 0.366 0/10 |
...
| 生成長 | Cumo | CuPy | PyTorch | CuPy / Cumo | PyTorch / Cumo |
|---|---|---|---|---|---|
| 64 | 465.5 | 150.5 | 359.1 | 0.324 0/10 | 0.774 0/10 |
| 200 | 501.7 | 147.8 | 371.3 | 0.292 0/10 | 0.740 0/10 |
...
| 条件 | Cumo | CuPy | PyTorch | CuPy / Cumo | PyTorch / Cumo |
|---|---|---|---|---|---|
| decode 72 トークン | 155.8 | 50.1 | 144.9 | 0.320 0/10 | 0.925 0/10 |
| encode 2048 トークン | 2831.1 | 2732.2 | 2810.5 | 0.965 1/10 またぐ | 0.994 4/10 またぐ |
...
| 条件 | Cumo | CuPy | PyTorch | CuPy / Cumo | PyTorch / Cumo |
|---|---|---|---|---|---|
| decode (tokens/sec) | 756.1 | 231.9 | 716.7 | 0.306 0/10 | 0.945 0/10 |
| encode (positions/sec) | 228,269 | 179,117 | 262,905 | 0.786 0/10 | 1.151 10/10 |
...
| 綴り | Cumo | CuPy | CuPy / Cumo | カーネル/pass (Cumo) |
|---|---|---|---|---|
| `shift` | 625.0 | 430.2 | 0.689 0/10 | 526 |
| `unfold` | 922.1 | 993.8 | 1.076 10/10 | 330 |
...
Cumo と PyTorch を同じバッチでインターリーブした区間別。s/step (1 ステップにかかった秒数) で、小さいほど速い。本/step は 1 ステップで GPU に投入するカーネルの本数。Cumo / PyTorch は時間の比なので、1 を超えるほど Cumo が遅い (11 ラウンドの先頭を位置で捨てて 10 ラウンド、対照つき)。

| 区間 | 本/step | Cumo | PyTorch | Cumo / PyTorch |
|---|---|---|---|---|
| forward | 331 | 0.00954 | 0.00792 | 1.21 (10/10。ただし幅が 17.2% で値は読めない) |
| backward | 1755 | 0.02944 | 0.01805 | 1.64 10/10 |
| update (AdamW) | 2861 | 0.03771 | 0.02000 | 1.87 10/10 |
| 合計 | 4947 | 0.07669 | 0.04598 | 1.66 10/10 |
